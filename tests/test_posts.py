...
class TestPosts(BaseTest):
    ...
    @pytest.mark.parametrize("case", [
        ...
        pytest.param(GetPostsByRoleTestCase(role="user_eve",
                                            params=GetPostsParams(hashtag="devlife",
                                                                  author_id="00000000-0000-0000-0000-000000000002",
                                                                  sort_by="likes_count", page=2, per_page=100,
                                                                  sort_order="desc")),
        ...
        pytest.param(GetPostsByRoleTestCase(role="user_eve",
                                            params=GetPostsParams(author_id="00000000-0000-0000-0000-999999999999",
                                                                  page=1, per_page=10)),
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed posts at platform")
    @allure.title("Get posts list - depending on role ({role})")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
        pytest.param(GetPostsByRoleTestCase(params=GetPostsParams(), role="admin"), id="Request posts list as admin"),
        pytest.param(GetPostsByRoleTestCase(params=GetPostsParams(), role="moderator"),
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed posts at platform")
    @allure.title("Get posts list - invalid queries")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(GetPostsByRoleTestCase(role="user_bob",
                                            params=GetPostsParams(sort_by="comments_count", sort_order="asc", page=0,
                                                                  per_page=10)),
        ...
        pytest.param(GetPostsByRoleTestCase(role="user_bob",
                                            params=GetPostsParams(author_id="00000000-0000-0000-0000-000000000003",
                                                                  page=3, per_page=101)),
                     id="invalid per_page above maximum"),
        pytest.param(GetPostsByRoleTestCase(role="user_bob",
                                            params=GetPostsParams(sort_by="views_count", sort_order="asc", per_page=10,
                                                                  page=1)),
                     id="invalid sort_by enum"),
        pytest.param(GetPostsByRoleTestCase(role="user_bob",
                                            params=GetPostsParams(sort_by="created_at", sort_order="up", per_page=10,
                                                                  page=1)),
    ...
    @pytest.mark.parametrize("case", [
        ...
        pytest.param(CreatePostByRoleTestCase(role="user_bob",
                                              payload=CreatePostPayload(content=f"Another valid post",
                                                                        visibility="followers_only")),
                     id="valid followers_only without image"),
        pytest.param(CreatePostByRoleTestCase(role="user_eve",
                                              payload=CreatePostPayload(content=f"Image post", visibility="public",
                                                                        image_url="image.jpg")),
                     id="valid public with image"),
        pytest.param(CreatePostByRoleTestCase(role="user_bob",
                                              payload=CreatePostPayload(content=f"Default visibility post",
                                                                        visibility="public")),
    ...
    def test_create_post(self, case, post_cleaner):
        ...
        if payload.image_url:
            assert isinstance(new_post.image_url,
                              str), f"Created post has image_url with unexpected type: {type(new_post.image_url)}"

    @allure.suite("Posts")
    @allure.sub_suite("Create post")
    @allure.feature("Posts")
    @allure.story("User can create post at platform")
    @allure.title("Create post - depending on role ({role})")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can create post at platform")
    @allure.title("Create post - invalid payload")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        ...
        pytest.param(CreatePostByRoleTestCase(role="admin",
                                              payload=CreatePostPayload(content="Valid post content",
                                                                        visibility="private")),
                     id="valid followers_only without image"),
    ])
    ...
    @allure.suite("Posts")
    @allure.sub_suite("Get posts feed")
    @allure.feature("Posts")
    @allure.story("User can read existed posts of feed at platform")
    @allure.title("Get posts feed")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
        pytest.param(GetFeedByRoleTestCase(role="user_eve", params=GetFeedParams(page=1, per_page=1)),
                     id="valid minimum boundaries"),
        pytest.param(GetFeedByRoleTestCase(role="user_eve", params=GetFeedParams(page=2, per_page=100)),
                     id="valid maximum boundary"),
        pytest.param(GetFeedByRoleTestCase(role="user_eve", params=GetFeedParams(page=None, per_page=None)),
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed posts of feed at platform")
    @allure.title("Get posts feed depending on user ({role})")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed posts of feed at platform")
    @allure.title("Get posts feed - invalid query params")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(GetFeedByRoleTestCase(role="user_bob", params=GetFeedParams(page=0, per_page=10)),
                     id="invalid page below minimum"),
        pytest.param(GetFeedByRoleTestCase(role="user_bob", params=GetFeedParams(page=1, per_page=0)),
                     id="invalid per_page below minimum"),
        pytest.param(GetFeedByRoleTestCase(role="user_bob", params=GetFeedParams(page=3, per_page=101)),
                     id="invalid per_page above maximum"),
    ])
    ...
    @allure.suite("Posts")
    @allure.sub_suite("Get certain post")
    @allure.feature("Posts")
    @allure.story("User can read existed post at platform")
    @allure.title("Get certain post, depending on role ({role})")
    @pytest.mark.smoke
    @pytest.mark.positive
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed post at platform")
    @allure.title("Get certain post - removed post")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Posts")
    @allure.story("User can read existed post at platform")
    @allure.title("Get certain post - not existed post_id")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.suite("Posts")
    @allure.sub_suite("Update post")
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post as author")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post - post removed before")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post - allowed period to edit is expired")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post - post created by another user")
    @pytest.mark.regression
    @pytest.mark.positive
    ...
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post - doesn't exist")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(UpdatePostByRoleTestCase(role="user_eve", payload=UpdatePostPayload(content="A-edited")),
    ...
    @allure.feature("Posts")
    @allure.story("User can update created post")
    @allure.title("Update post - invalid payload")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
    ...
    @allure.suite("Posts")
    @allure.sub_suite("Remove post")
    @allure.feature("Posts")
    @allure.story("User can remove created post")
    @allure.title("Remove post")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can remove created post")
    @allure.title("Remove post depends on user's role (admin, moderator)")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can remove created post")
    @allure.title("Remove post - post of another user")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("post_builder_user, case", [
    ...
    @allure.feature("Posts")
    @allure.story("User can remove created post")
    @allure.title("Remove post - not existed post id")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(DeletePostByRoleTestCase(role="user_eve", params=DeletePostParams()),
                     id="Remove post that doesn't exist"),
    ])
    ...
    @allure.suite("Repost")
    @allure.sub_suite("Repost post")
    @allure.feature("Repost")
    @allure.story("User can repost existed post")
    @allure.title("Repost post")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("build_post_by_user, case", [
        pytest.param("user_bob",
                     CreateRepostByRoleTestCase(role="user_eve", payload=CreateRepostPayload(repost_type="repost")),
                     id="Repost post - repost type and without content"),
        pytest.param("user_bob", CreateRepostByRoleTestCase(role="user_eve",
                                                            payload=CreateRepostPayload(repost_type="quote",
                                                                                        content="A" * 2000)),
                     id="Repost post - quote type and  max content boundary"),
        pytest.param("user_bob",
                     CreateRepostByRoleTestCase(role="user_eve", payload=CreateRepostPayload(content="Content only")),
    ...
    @allure.feature("Repost")
    @allure.story("User can repost existed post")
    @allure.title("Repost post - invalid payload")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("build_post_by_user, case", [
    ...
    @allure.feature("Repost")
    @allure.story("User can repost existed post")
    @allure.title("Repost post - not existed")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(CreateRepostByRoleTestCase(role="user_bob",
                                                payload=CreateRepostPayload(repost_type="repost", content="A" * 2)),
    ...
    @allure.feature("Repost")
    @allure.story("User can repost existed post")
    @allure.title("Repost post - post is removed")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(CreateRepostByRoleTestCase(role="user_bob",
    ...
    @allure.suite("Posts")
    @allure.sub_suite("Pin/unpin post")
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("Pin post")
    @pytest.mark.regression
    @pytest.mark.positive
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("UnPin post")
    @pytest.mark.regression
    @pytest.mark.positive
    @pytest.mark.parametrize("case_user", [
        pytest.param("user_eve", id="unpin post"),
    ])
    def test_unpin_post(self, build_post_pin_remove, case_user):
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("Attempt to pin post of another user by user with different roles: {test_data['user]}")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("Pin the post - doesn't exist")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case_user", [
        pytest.param("user_eve", id="Pin the post that "), ])
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("Pin the post - removed post")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case_user", [
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("Attempt to unpin post of another user by user with different roles: {test_data['user]}")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("UnPin the post that doesn't exist")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case_user", [
        pytest.param("user_eve", id="UnPin the post that doesn't exist"),
    ])
    ...
    @allure.feature("Posts")
    @allure.story("User can pin/unpin existed post")
    @allure.title("UnPin the post - removed")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case_user", [
        pytest.param("user_eve",
