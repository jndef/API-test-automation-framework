...
from services.comments.payloads import CreateCommentByRoleTestCase, \
    UpdateCommentByRoleTestCase, UpdateCommentPayload, CreateCommentPayload
...
class TestComments(BaseTest):
    ...
    @allure.sub_suite("Get comments list")
    @allure.story("User can read existed comments to post")
    @allure.title("Get comment list")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
        pytest.param(GetCommentsByRoleTestCase(role="user_eve",
                                               params=GetCommentsQueryParams(sort_by="created_at", sort_order="asc",
                                                                             page=1, per_page=1)),
                     id="Get comment list - min boundaries with created_at asc sorting"),
        pytest.param(GetCommentsByRoleTestCase(role="moderator",
                                               params=GetCommentsQueryParams(sort_by="likes_count", sort_order="desc",
                                                                             page=2, per_page=10)),
    ...
    @allure.sub_suite("Get comments list")
    @allure.story("User can read existed comments to post")
    @allure.title("Get posts list, incorrect - invalid payload")
    ...
    @pytest.mark.parametrize("case", [
        ...
        pytest.param(
            GetCommentsByRoleTestCase(role="user_eve", params=GetCommentsQueryParams(sort_order="invalid_order")),
            id="Get comment list - invalid payload, incorrect sort_order value"),
        pytest.param(GetCommentsByRoleTestCase(role="user_bob", params=GetCommentsQueryParams(page=0)),
        ...
        pytest.param(GetCommentsByRoleTestCase(role="user_bob", params=GetCommentsQueryParams(per_page=101)),
    ...
    @allure.sub_suite("Get comments list")
    @allure.story("User can read existed comments to post")
    @allure.title("Get posts list, incorrect - Removed post")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.sub_suite("Get comments list")
    @allure.story("User can read existed comments to post")
    @allure.title("Get posts list, incorrect - not existed post id")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.sub_suite("Get comments list")
    @allure.story("User can read existed comments to post")
    @allure.title("Get posts list, incorrect - Invalid uuid")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Create new comment")
    @allure.suite("Create new comment")
    @allure.sub_suite("Create new comment")
    @allure.story("User can create new comment to the post")
    @allure.title("Create comment to post")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    def test_create_comment(self, case, build_post_remove, comment_cleaner):
        ...
        comment_cleaner(comment.id)  # register on deletion
    ...
    @allure.sub_suite("Create new comment")
    @allure.story("User can create new comment to the post")
    @allure.title("Create comment to post - invalid payload")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
    ...
    @allure.sub_suite("Create new comment")
    @allure.story("User can create new comment to the post")
    @allure.title("Create comment to post - not existed post")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(
            CreateCommentByRoleTestCase(role="user_bob", payload=CreateCommentPayload(content="Valid comment")),
    ...
    @allure.sub_suite("Create new comment")
    @allure.story("User can create new comment to the post")
    @allure.title("Create comment to post - Removed post")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(
    ...
    @allure.sub_suite("Create new comment")
    @allure.story("User can create new comment to the post")
    @allure.title("Create comment to post - invalid post uuid")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(
    ...
    def test_create_comment_incorrect_invalid_uuid(self, case):
        comments_service = self.get_actor(case.role).comments_api
    ...
    @allure.feature("Update existed comment")
    @allure.suite("Update existed comment")
    @allure.sub_suite("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("Update existed comment")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
        pytest.param(UpdateCommentByRoleTestCase(role="user_bob", payload=UpdateCommentPayload(content="a")),
                     id="Update comment - Valid minimal content boundary"),
        pytest.param(UpdateCommentByRoleTestCase(role="user_bob", payload=UpdateCommentPayload(content="A" * 1000)),
    ...
    @allure.feature("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("Update existed comment - negative payload")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="")),
                     id="Update comment - content below minimum boundary"),
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="A" * 1001)),
                     id="Create comment - content above maximum boundary"),
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload()),
                     id="Create comment - content above maximum boundary"),
    ])
    ...
    @allure.feature("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("Update existed comment - Invalid comment uuid")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="A")),
    ...
    @allure.feature("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("Update existed comment - Comment is deleted")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="A")),
    ...
    @allure.feature("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("Attempt to edit comment created by another user")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("comment_creator, case", [
        pytest.param("user_bob",
                     UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="A")),
    ...
    @allure.feature("Update existed comment")
    @allure.story("User can update existed comment")
    @allure.title("User can update existed comment - not existed")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
        pytest.param(UpdateCommentByRoleTestCase(role="user_eve", payload=UpdateCommentPayload(content="A")),
    ...
    @allure.sub_suite("Delete existed comment")
    @allure.feature("Delete existed comment")
    @allure.story("User can remove existed comment")
    @allure.title("Delete existed comment")
    @pytest.mark.smoke
    @pytest.mark.positive
    ...
    @allure.feature("Delete existed comment")
    @allure.story("User can remove existed comment")
    @allure.title("Attempt to remove the comment created by another user with higher role")
    @pytest.mark.regression
    @pytest.mark.positive
    ...
    @allure.feature("Delete existed comment")
    @allure.story("User can remove existed comment")
    @allure.title("As user try to remove the comment, created by another user")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("comment_creator, case_user", [
    ...
    @allure.sub_suite("Get replies list")
    @allure.feature("Get replies list")
    @allure.story("User can read existed replies to comment")
    @allure.title("Get replies list")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
    ...
    def test_get_replies(self, db_get_comment_with_replies, case):
        prepared_comment_id = db_get_comment_with_replies()
        comments_service = self.get_actor(case.role).comments_api
    ...
    @allure.feature("Get replies list")
    @allure.story("User can read existed replies to comment")
    @allure.title("Get replies list, incorrect - invalid query param")
    @pytest.mark.regression
    @pytest.mark.negative
    @pytest.mark.parametrize("case", [
    ...
    def test_get_replies_incorrect_invalid_payload(self, db_get_comment_with_replies, case):
        prepared_comment_id = db_get_comment_with_replies
        comments_service = self.get_actor(case.role).comments_api
    ...
    @allure.feature("Get replies list")
    @allure.story("User can read existed replies to comment")
    @allure.title("Get replies list, incorrect - Invalid comment uuid")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Get replies list")
    @allure.story("User can read existed replies to comment")
    @allure.title("Get replies list, incorrect - Comment is deleted")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Get replies list")
    @allure.story("User can read existed replies to comment")
    @allure.title("Get replies list, incorrect - Non-existing comment id")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.sub_suite("Create reply to comment")
    @allure.feature("Create reply to comment")
    @allure.story("User can create a reply to existed comment")
    @allure.title("Create reply to comment")
    @pytest.mark.smoke
    @pytest.mark.positive
    @pytest.mark.parametrize("case", [
        pytest.param(CreateCommentByRoleTestCase(role="user_eve", payload=CreateCommentPayload(content="A")),
    ...
    @allure.feature("Create reply to comment")
    @allure.story("User can create a reply to existed comment")
    @allure.title("Create reply to comment  - Comment is removed")
    @pytest.mark.regression
    @pytest.mark.negative
    ...
    @allure.feature("Create reply to comment")
    @allure.story("User can create a reply to existed comment")
    @allure.title("Create reply to comment  - Comment does not exist")
    @pytest.mark.regression
    @pytest.mark.negative
